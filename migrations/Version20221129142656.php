 ...
 */
final class Version20221129142656 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE announcement (id INT AUTO_INCREMENT NOT NULL, region_id INT NOT NULL, user_id INT DEFAULT NULL, category_id INT DEFAULT NULL, title VARCHAR(50) NOT NULL, message LONGTEXT NOT NULL, address VARCHAR(255) NOT NULL, date DATE NOT NULL, date_start DATE DEFAULT NULL, date_end DATE DEFAULT NULL, image VARCHAR(100) NOT NULL, city VARCHAR(100) NOT NULL, zipcode INT NOT NULL, INDEX IDX_4DB9D91C98260155 (region_id), INDEX IDX_4DB9D91CA76ED395 (user_id), INDEX IDX_4DB9D91C12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
